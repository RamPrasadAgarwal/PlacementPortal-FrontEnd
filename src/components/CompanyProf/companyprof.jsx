...
function Detail1() {
  return (
            <div className= "profile1">
                ...
                <div>
                    <Descript value="Job Description"
                              info=" Deloitte USI
                                      Bangalore,India"/>   
                    <hr/>
                    <Descript value="About Company"
                              info=" Deloitte USI
                                      Bangalore,India"/>   
                    <hr/>
                    <Descript1 value="Requirements"
   ...
   render()
   {
      return(
              <div>
                ...
                <div className="link">   
                    <center><button
                                    onClick={this.toggleHidden.bind(this)}>{this.state.isHidden ? "MORE":"LESS"}
                            </button>
                    </center>
                </div> 
              </div>
